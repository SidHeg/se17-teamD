    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qrcode', models.DateTimeField(verbose_name='date published')),
                ('gps', models.DateTimeField(verbose_name='date published')),
                ('nfc', models.DateTimeField(verbose_name='date published')),
            ],
        ),
        migrations.CreateModel(
            name='course',
